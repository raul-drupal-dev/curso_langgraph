...
def decide_path(state: State) -> Literal["suggest_morning","suggest_afternoon"]:
...
- **Encadenamiento Dinámico:** Los flujos no siempre son lineales, y LangGraph permite construir grafos que se adaptan a diferentes situaciones.  
