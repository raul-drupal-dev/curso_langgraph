...
Hemos de tener en cuenta, que podriamos almacenar esa informacion en una variable, una base de datos o un archivo, aunque mas adelante veremos mejores formas de hacerlo, 
