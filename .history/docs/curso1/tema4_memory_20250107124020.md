...
La mejor forma para aplicar una memoria costa es sin duda aplicar MemorySaver, pero existen otras alternativas, como almanezar el hisotico en una variable he ir pasando esa variable una y otra vez para que el LLM pueda tener el contexto
