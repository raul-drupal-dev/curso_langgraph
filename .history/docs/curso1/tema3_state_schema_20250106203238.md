...
Como vemos el grafo no guarda el historico del chat, haciendo que el LLM no pueda tener acceso a información previa y por eso no es capaz de recordad mi nombre.
