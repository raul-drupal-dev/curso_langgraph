...
Es importante tener en cuenta que al eliminar mensajes puede que la estructura de mensajes cambie y de errores al procesar el LLM, ya que algunos LLM tienen una structura la cual solo funciona si el primer mensaje es 
