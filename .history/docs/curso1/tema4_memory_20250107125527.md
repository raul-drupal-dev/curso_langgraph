...
Como podemos observar, esta forma tambien tendria memoria, aunque se tendria que manejar de forma manual.
Hemos de tener en cuenta, que podriamos almacenar esa informacion en una variable, una base de datos o un archivo, aunque mas adelante veremos mejores formas de hacerlo, esta puede ser una posible solucion a tu proyecto.
