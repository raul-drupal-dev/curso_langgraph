...
:simple-googlecolab: Ver notebook en [Más ejemplos](https://colab.research.google.com/github/langchain-ai/langchain-academy/blob/main/module-2/state-schema.ipynb)
