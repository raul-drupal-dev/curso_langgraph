...
La mejor forma para aplicar una memoria costa es sin duda usando MemorySaver, pero existen otras alternativas, como almacenar el histórico en una variable e ir pasando esa variable una y otra vez para que el LLM pueda tener el contexto de la conversación.
