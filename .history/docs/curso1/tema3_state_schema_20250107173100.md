...
- **`preferences`** es una lista que guarda intereses o preferencias. Usando `Literal`forzamos a que la aplicación solamente pueda guardas esos terminos en concreto.  
...
{'name': 'Raul', 'age': 25, 'preferences': ['Programación']}
```
