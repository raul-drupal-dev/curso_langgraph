...
Copiar código
messages: Annotated[list[AnyMessage], add_messages]
Estás indicando que cuando un nodo devuelve una actualización parcial del estado, el reducer add_messages se encargará de combinar el valor nuevo con el existente.
